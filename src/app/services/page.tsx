...
const CATEGORIES = [
  {
    ...
    services: [
      ...
      { name: 'Cut + Beard + Eyebrow', desc: 'Best value — full look in one visit', price: '$55' },
      { name: 'Facial', desc: 'Skin care and facial treatment', price: 'From $85' },
    ],
  },
  {
    title: 'Salon',
    accent: false,
    services: [
      { name: 'Blowout', desc: 'Sleek, smooth, voluminous finish', price: 'From $50' },
      { name: 'Perms', desc: 'Waves and curls that last', price: 'From $80' },
      { name: 'Full Color', desc: 'Root-to-tip color application', price: 'From $90' },
      ...
      { name: 'Retouch', desc: 'Root touch-up and refresh', price: 'From $75' },
      { name: 'Toner / Gloss', desc: 'Tone, refresh, and shine', price: 'From $65' },
      { name: 'Styling', desc: 'Special occasion and event styling', price: 'From $55' },
  ...
  },
  {
    ...
    accent: false,
    services: [
      { name: 'Nails', desc: 'Nail design and care', price: 'From $55' },
      { name: 'Manicure', desc: 'Hand and nail treatment', price: 'From $45' },
      { name: 'Mani-Pedi', desc: 'Full hand and foot treatment', price: 'From $80' },
      { name: 'Eyelash Extensions', desc: 'Full set lash extensions', price: 'From $80' },
    ],
  },
  {
    title: 'Styling',
